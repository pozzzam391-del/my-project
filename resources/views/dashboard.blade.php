...
<body>
  ...
  <div class="form-container">
    ...
    <form id="loginForm">
      ...
      <div class="date-group">
        ...
        <input type="date" id="dob" class="input-field" placeholder="YYYY-MM-DD" required>
      ...
      <!-- ប៊ូតុង Login ត្រូវ Lock (disabled) ទុកជាមុន -->
  ...
  <script>
    // កំណត់ថ្ងៃ ខែ ឆ្នាំ ដែលត្រឹមត្រូវ (YYYY-MM-DD)
    ...
    // ពិនិត្យមើលរាល់ពេលជ្រើសរើសថ្ងៃខែ
    dateInput.addEventListener('change', function() {
      if (this.value === CORRECT_DATE) {
        // បើត្រូវ ៖ Unlock ប៊ូតុង
        ...
        statusMsg.textContent = "🔒 ជ្រើសរើសថ្ងៃខែខុសហើយ! ព្យាយាមម្តងទៀត។";
